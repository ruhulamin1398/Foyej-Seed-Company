...
<body>
    ...
    <style>
        ...
        table {
            bcustomerCashReceive-collapse: collapse;
            bcustomerCashReceive-spacing: 0
        }
        ...
        #fromto>#to {
            float: right;
            bcustomerCashReceive: solid grey 1px;
        }
        ...
        #items table td {
            bcustomerCashReceive-right: solid grey 2px
        }
        ...
        #items table tr:nth-child(1) {
            ...
            bcustomerCashReceive: solid grey 2px;
        }

        #items table tr th {
            bcustomerCashReceive-right: solid grey 1px;
            padding: 3px
        }
        ...
        #footer {
            ...
            bottom: 4%;
            right: 4%;
            bcustomerCashReceive-top: solid grey 1px
        }
