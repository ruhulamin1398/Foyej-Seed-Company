          ...
          <div class="col-xl-8 col-lg-7 ">
            ...
            <div class="row ">
              ...
              <div class="col-xl-4 col-md-6 mb-4  text-center  ">
                <div class="card border-none  h-100 p-4">
                  <div class="card-img-top ">
                  <a href="   {{ route('customer_cash_receive') }} "> <i class="fas fa-dollar-sign fa-2x  text-info "></i></a>
                  </div>
                  <div class="card-body">
                    <div class="row no-gutters align-items-center">
                      <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-primary text-uppercase mb-1"> <a href="  {{ route('customer_cash_receive') }} ">Cash</a> </div>
                      </div>
