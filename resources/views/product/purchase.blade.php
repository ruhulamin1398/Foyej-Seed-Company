            ...
            <form id="purchaseProductInputForm" >
                ...
                <div class="form-row align-items-center">
                    ...
                    <div class="col-auto">
                        ...
                        <input type="text" name="name"  id ="purchaseProductInputName" size="20" value=0 class="form-control  mb-2">
                    </div>
                    <div class="col-auto">
                    ...
                    <div class="col-auto">
                        <button type="button" id ="purchaseProductInputSubmit" class="btn btn-success mt-3">Submit</button>
                    </div>
